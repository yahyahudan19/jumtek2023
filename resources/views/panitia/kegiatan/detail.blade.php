        ...
        <div class="container-fluid"> 
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" ><a href="/dashboard/kegiatan"><td class="py-2 text-right"><span class="badge badge-warning">Kembali<span
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form method="POST" action="/kegiatan/update/{{$data_kegiatan->id_kegiatan}}">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="basic-form">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan"  value="{{$data_kegiatan->nama_kegiatan}}" required>
                                                </div>
                                                <div class="col-xl-3 col-xxl-6 col-md-6 mb-3">
                                                    <label>Tanggal Kegiatan</label>
                                                    <input type="text" id="mdate" name="tanggal_kegiatan" class="form-control" placeholder="Ini Tanggal" value="{{$data_kegiatan->tanggal_kegiatan}}">
                                                </div>
                                                <div class="col-xl-3 col-xxl-6 col-md-6 mb-3">
                                                    <label>Waktu Kegiatan</label>
                                                    <input type="text" id="timepicker" name="waktu_kegiatan" class="form-control" placeholder="Ini Waktu" value="{{$data_kegiatan->waktu_kegiatan}}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Jenis Kegiatan</label>
                                                    <select id="jenis_kegiatan" name="jenis_kegiatan" class="btn btn-primary light btn-rounded form-control default-select" disabled>
                                                        <option selected>{{$data_kegiatan->jenis_kegiatan}}</option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="tingkat_kegiatan" name="tingkat_kegiatan" class="btn btn-primary light btn-rounded form-control default-select" disabled>
                                                        <option selected>{{$data_kegiatan->tingkat_kegiatan}}</option>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea type="text" class="form-control" name="detail_kegiatan" required> {{$data_kegiatan->detail_kegiatan}}</textarea>
                                                </div>
                                            </div>
                                            <div class="">
